...
PYBIND11_MODULE(RAISIMGYM_TORCH_ENV_NAME, m) {
  py::class_<VectorizedEnvironment_for_test<ENVIRONMENT_for_test>>(m, "RaisimGymEnv")
    ...
    .def("observe2", &VectorizedEnvironment_for_test<ENVIRONMENT_for_test>::observe2)
    .def("step", &VectorizedEnvironment_for_test<ENVIRONMENT_for_test>::step)
    .def("step2", &VectorizedEnvironment_for_test<ENVIRONMENT_for_test>::step2)
    ...
    .def("setObStatistics", &VectorizedEnvironment_for_test<ENVIRONMENT_for_test>::setObStatistics)
    .def("setObOStatistics", &VectorizedEnvironment_for_test<ENVIRONMENT_for_test>::setObOStatistics)
